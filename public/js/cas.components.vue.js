// All components goes in here
const btn_counter = `<button v-on:click='count++' class='btn btn-info'> Clicked {{count}}</button>`;

const apply_component = `<div class="row">
...
const payments_component = `<div class="card card-default color-palette-box">
